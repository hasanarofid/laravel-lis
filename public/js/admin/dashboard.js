...
//donat chart
function income_chart_donat_statistics()
{
  $.ajax({
    url:ajax_url('get_income_chart_donat'),
    beforeSend:function(){
      $('.preloader').show();
      $('.loader').show();
    },
...
$('#income_chart_donat').append(`
  <canvas id="income_chart_statistics_donat"  height="${height}" width="80vw"></canvas>
`);

    var ctx = document.getElementById('income_chart_statistics_donat');
