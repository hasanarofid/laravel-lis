...
<head>
   ...
   <style>
      @if($type==3||$type==4||$type==5||$type==6||$type==7) @page {
         ...
         margin-bottom: {
               {
               $reports_settings['margin-bottom']
            }
         }
      ...
      @else @page {
         ...
         margin-top: {
               {
               $reports_settings['content-margin-top']
            }
         }
         ...
         margin-bottom: {
               {
               $reports_settings['content-margin-bottom']
            }
         }
      ...
      .branch_name {
         color: {
               {
               $reports_settings['branch_name']['color']
            }
         }
         ...
         font-size: {
               {
               $reports_settings['branch_name']['font-size']
            }
         }
         ...
         font-family: {
               {
               $reports_settings['branch_name']['font-family']
            }
         }
      ...
      .branch_info {
         color: {
               {
               $reports_settings['branch_info']['color']
            }
         }
         ...
         font-size: {
               {
               $reports_settings['branch_info']['font-size']
            }
         }
         ...
         font-family: {
               {
               $reports_settings['branch_info']['font-family']
            }
         }
      ...
      .title {
         color: {
               {
               $reports_settings['patient_title']['color']
            }
         }
         ...
         font-size: {
               {
               $reports_settings['patient_title']['font-size']
            }
         }
         ...
         font-family: {
               {
               $reports_settings['patient_title']['font-family']
            }
         }
      ...
      .data {
         color: {
               {
               $reports_settings['patient_data']['color']
            }
         }
         ...
         font-size: {
               {
               $reports_settings['patient_data']['font-size']
            }
         }
         ...
         font-family: {
               {
               $reports_settings['patient_data']['font-family']
            }
         }
      ...
      .header {
         border: {
               {
               $reports_settings['report_header']['border-width']
            }
         }

         solid {
               {
               $reports_settings['report_header']['border-color']
            }
         }
         ...
         background-color: {
               {
               $reports_settings['report_header']['background-color']
            }
         }
         ...
         text-align: {
               {
               $reports_settings['report_header']['text-align']
            }
         }
      ...
      .footer {
         border: {
               {
               $reports_settings['report_footer']['border-width']
            }
         }

         solid {
               {
               $reports_settings['report_footer']['border-color']
            }
         }
         ...
         background-color: {
               {
               $reports_settings['report_footer']['background-color']
            }
         }
         ...
         color: {
               {
               $reports_settings['report_footer']['color']
            }
         }
         ...
         font-size: {
               {
               $reports_settings['report_footer']['font-size']
            }
         }
         ...
         font-family: {
               {
               $reports_settings['report_footer']['font-family']
            }
         }
         ...
         text-align: {
               {
               $reports_settings['report_footer']['text-align']
            }
         }
      ...
      .signature {
         color: {
               {
               $reports_settings['signature']['color']
            }
         }
         ...
         font-size: {
               {
               $reports_settings['signature']['font-size']
            }
         }
         ...
         font-family: {
               {
               $reports_settings['signature']['font-family']
            }
         }
   ...
   <htmlpageheader name="page-header">
      ...
      <table width="100%" class="table table-bordered pdf-header">
         <tbody>
            ...
            <tr>
               <td>
                  <span class="title">{{__('Doctor')}} :</span> <span class="data">
               ...
               <td>
                  <span class="title">{{__('Contract')}} :</span> <span class="data">
